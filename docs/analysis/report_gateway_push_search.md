...
> **辅助上下文**：另阅读了 `beacon-common` 中的 `StandardSubmit`、`StandardReport`、`RabbitMQConstants`、`CacheKeyConstants`、`CMPP2ResultEnums`、`CMPP2DeliverEnums`，以及 `docs/06_ES作用与交互分析.md`、ES 种子数据。
...
| P40 | 查询只覆盖当年索引，跨年查询/统计缺失（docs 亦指出） | `ElasticsearchServiceImpl.java:143,189`、`docs/06_ES作用与交互分析.md:37,342` |
