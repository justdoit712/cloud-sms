...
- `docs/02_项目详细分析总报告.md`（§5 RabbitMQ 消息拓扑）
- `docs/analysis/report_gateway_push_search.md`（网关/回调/搜索模块深挖）
...
1. `docs/02_项目详细分析总报告.md`（38 项风险清单）
2. `docs/analysis/`（四大模块深挖报告）
...
- `README.md`
- `docs/02_项目详细分析总报告.md`
- `docs/analysis/`（四大模块深挖报告）
